...
st.title('Dados Brutos dos Produtos :bar_chart:')
...
with st.expander('Colunas'):
    colunas = st.multiselect('Selecionecione as colunas que deseja visualizar', list(dados.columns), list(dados.columns))
